...
public class RdsTestContainer extends TestContainer {

    public RdsTestContainer() {
        super();
    ...
    public static class Common extends RdsTestContainer {

        public static final RdsTestContainer.Common INSTANCE = new RdsTestContainer.Common();
